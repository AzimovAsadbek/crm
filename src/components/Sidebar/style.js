...
const MenuInfo = styled(NavLink)`
    display: flex;
    padding: 12px 24px;
    color: ${({ $active }) => $active ? "var(--activeColor)" : "var(--primaryColor)"};
...
const ChildWrapper = styled.div`
    ...
    overflow: hidden;
    margin-left: 40px;
    color: ${({ $activepath }) => $activepath ? "var(--activeColor)" : "var(--primaryColor)"};
...
export {
    Container, SidebarContainer, Body, Wrapper, Logo, Profile, Title
    , SubTitle, Menu, MenuInfo, MenuTitle, ChildWrapper, ChildTitle, Row, Exit, Wrap
}