...
const AllStudents = () => {
    ...
    return <Container>
        ...
        <Breadcrumb>
            ...
            <GenericButton type={"add"} onClick={() => setOpenModal(true)} $bgcolor={"#722ED1"}>Student
                qoshish</GenericButton>
        </Breadcrumb>
        <GenericTable open={open} headCells={useCells(onEdit, onMove)} rows={state} spinner={spinner}>
